/* face_trials.js
   ...
   Builds the 110-trial face perception task:
     ...
     -> manipulated feedback (pre-generated, one of 4 between-subjects
        conditions). The face image stays visible (smaller) while feedback
        ("Correct!" / "Incorrect, correct answer: XX") is shown above it.
        On "incorrect" trials, the "correct answer" shown is a randomly
        chosen emotion, guaranteed to differ from whatever the participant
        actually selected. Correct feedback triggers a small confetti burst
        (requires the canvas-confetti script to be loaded - see note below).
...
const IMAGE_DISPLAY_HEIGHT_PX = 260; // smaller face image, used both during response and feedback
