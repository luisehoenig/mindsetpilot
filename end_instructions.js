...
/* Open-ended suspicion probe (before debriefing) */
const suspicionProbe = {
  type: jsPsychSurveyHtmlForm,

  preamble: `
    <div style="max-width: 800px; margin: 0 auto; text-align: left;">
      <p><strong>What do you think the study was about?</strong></p>
      <p>Please answer in your own words - there are no right or wrong answers.</p>
    </div>
  `,
  ...
  html: `
    <div style="margin: 30px 0;">
      <textarea
        id="perceived_study_purpose"
        name="perceived_study_purpose"
        rows="6"
        required
        style="
          width: 100%;
  ...
  data: {
    task: "perceived_study_purpose"
  }
};

window.end_instructions.push(suspicionProbe);
